...
import { Target, Lock, CheckCircle, Sparkles, Camera, Scan, Lightbulb } from 'lucide-react';
...
export function MissionsPage({ activities, onCompleteTask }: MissionsPageProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-green-800 mb-2">Eco Missions</h1>
      <p className="text-gray-600 mb-8">Complete guided missions to build sustainable habits</p>
