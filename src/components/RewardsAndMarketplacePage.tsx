...
import { Coffee, Gift, ShoppingBag, TreePine, Shirt, Book, Headphones, Heart, Leaf, Package, TrendingUp, DollarSign } from 'lucide-react';

interface RewardsAndMarketplacePageProps {
  userPoints: number;
  onRedeem: (points: number) => void;
}

export function RewardsAndMarketplacePage({ userPoints, onRedeem }: RewardsAndMarketplacePageProps) {
  const [activeSection, setActiveSection] = useState<'internal' | 'marketplace'>('internal');
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600">Redeem points for internal rewards or sustainable products</p>
        </div>
